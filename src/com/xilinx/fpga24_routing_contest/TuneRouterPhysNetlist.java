...
public class TuneRouterPhysNetlist {
    public static void main(String[] args) throws IOException {
        if (args.length != 6) {
            System.err.println("USAGE: <input.phys> <output.phys> <ww> <ipcf> <pcm> <hcf>");
            return;
        }
        ...
        routerArgs.addAll(List.of("--wirelengthWeight", args[2]));
        routerArgs.addAll(List.of("--initialPresentCongestionFactor", args[3]));
        routerArgs.addAll(List.of("--presentCongestionMultiplier", args[4]));
        routerArgs.addAll(List.of("--historicalCongestionFactor", args[5]));
